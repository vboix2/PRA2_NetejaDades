...
legend("topright", legend=c("No sobrevive","Superviviente"), fill = c("cadetblue4","aquamarine"))
```
...
A continuació estudiarem els resultats en funció del valor de la variable numèrica *Age*. Crearem una piràmide representant les persones que sobreviuen a l'esquerra del 0 i els que no ho fan a la dreta. 
...
Al gràfic veiem clarament com l'interval d'edats (20,30] és el més nombrós i també com els homes adults (títol de Mr) són els que majoritàriament no sobreviuen. Destaquem un petit grup amb titol "Master" (es refereix als nens en anglés) de (0,10] anys al que hi sobreviuen aproximadament la meitat
