...
Com veiem, en aquest nou model hi ha més variables que resulten significatives i també millora la importància de *Embarked*. Si calculem novament la precisió veiem que gairebé no ha variat.
...
Obtenim una visió general de tot el dataframe de la solució del problema amb un gràfic de conjunts paral·lels al que hi mostrem les variables cualitatives amb més probabilitat de ser signiticatives al model. Pclass, SibSp, Parch, Cabin, Embarked, Title
...
Analitzem el comportament depenent de *Age*. Amb una piràmide, representem les persones que hi sobreviuen a l'esquerra del 0 i els que no ho fan, a la dreta. Al gràfic veiem clarament que el grup de (20,30] és el més nombrós, a més d'apreciar-se clarament que el homes (titol de Mr) són els que no sobreviuràn. Destaquem un petit grup amb titol "Master" (es refereix als nins en anglés) de (0,10] anys al que hi sobreviuen aproximadament la meitat
