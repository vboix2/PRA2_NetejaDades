...
Per fer les anàlisis de normalitat i homogeneïtat de la variància ens centrarem en els atributs de tipus *numeric*, que són *Age* i *Fare*. En primer lloc unirem els dos conjunts de dades en un mateix dataframe per faciltiar-ne l'estudi.
...
Analitzarem la normalitat de la distribució de l'atribut *Age*, primer de manera gràfica i després amb el test de Shapiro-Wilk.
...
* La probabilitat de sobreviure és significativament diferent entre les diferents categories?
* Quina és la probabilitat de sobreviure per als passatgers del conjunt test?
