...
```
### 4.2.2. Anàlisi d'homogeneitat de la variancia

Per tal de discriminar si la variància de les variables numèriques *Age* i *Flare*, és constant als grups de les persones que hi sobreviuen, respecte a les que no ho fan, es realitza l'anàlisi de l'homogeneïtat de la variància, com cap de les dues de les variables té una distribució normal es realitza el test Fligner-Killeen, que permet comparar les medianes de les variàncies en lloc de les mitjanes amb mostres de diferent grandària.
